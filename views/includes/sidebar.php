<div class="navview-pane">
        ...
        <div class="suggest-box">
            <div class="data-box">
                <img src="<?= $base_url ?>assets/img/amadin.jpg" class="avatar">
                <div class="ml-4 avatar-title flex-column">
                    <a href="#" class="d-block fg-white text-medium no-decor"><span class="reduce-1">Rahma Dina</span></a>
                    <p class="m-0"><span class="fg-green mr-2">&#x25cf;</span><span class="text-small">online</span></p>
                </div>
            </div>
            <img src="<?= $base_url ?>assets/img/amadin.jpg" class="avatar holder ml-2">
        </div>
        ...
        <ul class="navview-menu mt-4" id="side-menu">
            ...
            <li>
                <a href="jenis">
                    <span class="icon"><span class="mif-table fg-yellow"></span></span>
                    <span class="caption">Jenis</span>
                </a>
            </li>
            <li>
                <a href="barang">
                    <span class="icon"><span class="mif-suitcase fg-cyan"></span></span>
        ...
        <div class="w-100 text-center text-small data-box p-2 border-top bd-grayMouse" style="position: absolute; bottom: 0">
            <div>&copy; 2022</div>
            <div>Created with <a href="https://instagram.com/rhma.dnaa_" class="text-muted fg-white-hover no-decor">Rahma Dina Ariyanti</a></div>
        </div>
    </div>